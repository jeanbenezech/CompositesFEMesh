...
def write_parameters(cnt=-1,p1=0, p2=0, p3=0, p4=0, t_ply=0.196, Zlength = 420.0, height = 55.0, StackSeq = [], rotate_flanges = True, LFlange_theta = 0.0, RFlange_theta = 0.0, model_name = 'CSpar'):
	# t_ply = ply thickness
	...
	# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	config['GENERAL'] = {}
	config['GENERAL']['name(s)'] = model_name ### CerTest, CerTest_realistic, KubernetesTest,CerTest_test,CerTest_test_realistic, CerTest_testflanges, CerTest_testCornerRadius...
	...
	config['MESH']['dx(i)'] = '29' # 25 ;; 110 # Discretization top part of the C
	...
	config['MESH']['dz(i)'] = '84' # 150 // 1,9,25,9,1 ;; 1,20,90,20,1 # Discretization of the part lenght. if 1 int is provided: uniform; else multiple discretization
	config['MESH']['dc(i)'] = '5' # 7 ;; 15 # Discretization the corner
	config['MESH']['dflange_bot(i)'] = '6' # 6 ;; 12 # Discretization the flange bellow BC node
	config['MESH']['dflange_top(i)'] = '2' # 2 ;; 4 # Discretization the flange above BC node
